...
class Property(TimeStampedUUIDModel):
    ...
    class PropertyType(models.TextChoices):
        HOUSE="For Sale", _("For Sale")
        APARTMENT="For Rent", _("For Rent")
        OFFICE="Auction", _("Auction")
        WHAREHOUSE="Wharehouse", _("Wharehouse")
    ...
    country=CountryField(verbose_name=_("Country"), default="NGR", blank_label="(Select Country)")
    ...
    street_address=models.CharField(verbose_name=_("Street Address"), max_length=150, default="XYZ Avenue")
    ...
    tax=models.DecimalField(verbose_name=_("Property Tax"), max_digits=6, decimal_places=2, default=0.15, help_text="15% proprty tax charged")
    ...
    photo1=models.ImageField(verbose_name=_("Main Photo"), default="/house_sample.jpg", null=True, blank=True)
