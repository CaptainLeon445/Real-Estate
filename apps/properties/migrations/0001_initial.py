...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Property',
            fields=[
                ('uu_id', models.BigAutoField(editable=False, primary_key=True, serialize=False)),
                ...
                ('country', django_countries.fields.CountryField(default='NGR', max_length=2, verbose_name='Country')),
                ...
                ('street_address', models.CharField(default='XYZ Avenue', max_length=150, verbose_name='Street Address')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, help_text='15% proprty tax charged', max_digits=6, verbose_name='Property Tax')),
                ...
                ('property_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Rent'), ('Auction', 'Auction'), ('Wharehouse', 'Wharehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='Other', max_length=50, verbose_name='Property Type')),
                ('cover_photo', models.ImageField(blank=True, default='/house_sample.jpg', null=True, upload_to='', verbose_name='Main Photo')),
                ('photo1', models.ImageField(blank=True, default='/house_sample.jpg', null=True, upload_to='', verbose_name='Main Photo')),
